...
pub use opencl_sys::{
    ...
    CL_DEVICE_GLOBAL_MEM_CACHELINE_SIZE, CL_DEVICE_GLOBAL_MEM_CHANNEL_BANK_WIDTH_AMD,
    CL_DEVICE_GLOBAL_MEM_CHANNEL_BANKS_AMD, CL_DEVICE_GLOBAL_MEM_CHANNELS_AMD,
    ...
    CL_DEVICE_ID_INTEL, CL_DEVICE_IL_VERSION, CL_DEVICE_ILS_WITH_VERSION,
    ...
    CL_DEVICE_IP_VERSION_INTEL, CL_DEVICE_KERNEL_CLOCK_CAPABILITIES_KHR,
    CL_DEVICE_KERNEL_EXEC_TIMEOUT_NV, CL_DEVICE_LATEST_CONFORMANCE_VERSION_PASSED,
    CL_DEVICE_LINKER_AVAILABLE, CL_DEVICE_LOCAL_MEM_BANKS_AMD, CL_DEVICE_LOCAL_MEM_SIZE,
    ...
    CL_DEVICE_MEMORY_CAPABILITIES_IMG, CL_DEVICE_MIN_DATA_TYPE_ALIGN_SIZE, CL_DEVICE_NAME,
    ...
    CL_DEVICE_NATIVE_VECTOR_WIDTH_SHORT, CL_DEVICE_NODE_MASK_KHR,
    CL_DEVICE_NON_UNIFORM_WORK_GROUP_SUPPORT, CL_DEVICE_NOT_FOUND,
    ...
    CL_DEVICE_PCI_BUS_ID_NV, CL_DEVICE_PCI_BUS_INFO_KHR, CL_DEVICE_PCI_SLOT_ID_NV,
    CL_DEVICE_PCIE_ID_AMD, CL_DEVICE_PIPE_MAX_ACTIVE_RESERVATIONS, CL_DEVICE_PIPE_MAX_PACKET_SIZE,
    CL_DEVICE_PIPE_SUPPORT, CL_DEVICE_PLATFORM, CL_DEVICE_PREFERRED_CONSTANT_BUFFER_SIZE_AMD,
    ...
    CL_DEVICE_PREFERRED_VECTOR_WIDTH_SHORT, CL_DEVICE_PREFERRED_WORK_GROUP_SIZE_AMD,
    ...
    CL_DEVICE_QUEUE_ON_DEVICE_PROPERTIES, CL_DEVICE_QUEUE_ON_HOST_PROPERTIES,
    CL_DEVICE_QUEUE_REPLACEABLE_DEFAULT, CL_DEVICE_QUEUE_SUPPORTED, CL_DEVICE_REFERENCE_COUNT,
    ...
    CL_DEVICE_SIMD_WIDTH_AMD, CL_DEVICE_SINGLE_FP_CONFIG,
    ...
    CL_VERSION_MINOR_MASK, CL_VERSION_PATCH_BITS, CL_VERSION_PATCH_MASK, cl_amd_device_topology,
    ...
    cl_device_pci_bus_info_khr, cl_device_svm_capabilities, cl_device_type, cl_double, cl_float,
...
pub fn get_device_info(
    ...
    match param_name {
        ...
        | CL_DEVICE_MEMORY_CAPABILITIES_IMG // cl_device_kernel_clock_capabilities_khr
...
mod tests {
    ...
    use crate::platform::{CL_PLATFORM_VERSION, get_platform_ids, get_platform_info};
